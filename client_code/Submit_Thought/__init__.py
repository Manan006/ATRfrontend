from ._anvil_designer import Submit_ThoughtTemplate
from anvil import *
import anvil.server
...
class Submit_Thought(Submit_ThoughtTemplate):
  ...
  def push_thought_btn_click(self, **event_args):
    """This method is called when the button is clicked"""
    anvil.server.call('push_thought',self.thought.text)
    self.content_panel.clear()
    open_form('Base')
